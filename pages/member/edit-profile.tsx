                ...
                <div className="ps-lg-0">
                    ...
                    <div className="bg-card pt-30 ps-30 pe-30 pb-30">
                        <form action="">
                            <div className="photo d-flex">
                                <div className="position-relative me-20">
                                    ...
                                    <div
                                        ...
                                        <Image src="/icon/profile.svg" width={120} height={120}/>
                                    </div>
                                </div>
                            ...
                            <div className="pt-30">
                              <Input label='Full Name' htmlFor='Fullname' inputType='text' />
                            </div>
                            <div className="pt-30">
                              <Input label='Address' htmlFor='Address' inputType='text'/>
                            </div>
                            <div className="pt-30">
                              <Input label='Phone' htmlFor='Phone' inputType='tel'/>
                            </div>
