import { NominalsTypes, PaymentTypes } from "../../../../../services/players/data-types"
      ...
      <div className="pt-md-50 pb-md-50 pt-30 pb-20">
        ...
        <div className="row justify-content-between">
          {nominals.map((nominal) => {
              return <NominalItem key={nominal._id} id={nominal._id} coinQuantity={nominal.coinQuantity} coinName={nominal.coinName} price={nominal.price}/>
          })}
          ...
          <div className="row justify-content-between">
            {payments.map((payment) => {
              return payment.banks.map((bank) => (
                <PaymentMethod key={payment._id} bankID={bank._id} bankName={bank.bankName} type={payment.type} />
              ))
            })}
            <div className="col-lg-4 col-sm-6"></div>
          </div>
