              ...
              <div className="main-content main-content-card overflow-auto">
                  <section className="checkout mx-auto">
                      ...
                      <div className="purchase pt-30">
                          ...
                          <Row label='Your Game ID' value='DB051GG' />
                          ...
                          <Row label='Total' value={55000600} customClass="color-palette-4" />
                      </div>
                      <div className="payment pt-10 pb-10">
                          <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                          <Row label='Your Account Name' value='Apocalypse' />
                          <Row label='Type' value='Worldwide Transfer' />
                          <Row label='Bank Name' value='Bank Central Asia' />
                          <Row label='Bank Account Name' value='PT Store GG' />
                          <Row label='Bank' value='1800 - 9090 - 2021' />
                      </div>
